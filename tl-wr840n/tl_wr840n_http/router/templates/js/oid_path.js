...
var oid_str = {
    ...
    /*  20 */ "ACL_CFG" : "InternetGatewayDevice.X_TP_AppCfg.ACL.{i}.",
              "WAN_TYPE_DETECT": "InternetGatewayDevice.X_TP_AppCfg.WanTypeDetect.",
    ...
    /*  54 */ "LAN_WLAN_TASK_SCHEDULE" : "InternetGatewayDevice.LANDevice.{i}.WLANConfiguration.{i}.X_TP_TaskSchedule.",
              "LAN_WLAN_QUICKSAVE" : "InternetGatewayDevice.LANDevice.{i}.WLANConfiguration.{i}.X_TP_QuickSave.",
    ...
    /*  61 */ "WAN_DSL_INTF_STATS_TOTAL" : "InternetGatewayDevice.WANDevice.{i}.WANDSLInterfaceConfig.Stats.Total.",
              "WAN_DSL_AUTOPVC" : "InternetGatewayDevice.WANDevice.{i}.WANDSLInterfaceConfig.X_TP_AutoPVC.",
              "WAN_DSL_AUTO_PVC_PAIR" : "InternetGatewayDevice.WANDevice.{i}.WANDSLInterfaceConfig.",
    /*  62 */ "WAN_ETH_INTF" : "InternetGatewayDevice.WANDevice.{i}.WANEthernetInterfaceConfig.X_TP_AutoPVC.PVCPair.{i}.",
    ...
    /* 209 */ "GPON_OMCI_ME_ATTR" : "InternetGatewayDevice.X_TP_GponMacInfo.OmciIot.OmciIotEntry.{i}.MeAttr.{i}.",
              "IPPING_DIAG" : "InternetGatewayDevice.IPPingDiagnostics.",
              "TRACEROUTE_DIAG" : "InternetGatewayDevice.TraceRouteDiagnostics.",
              "SDMZ_CFG" : "InternetGatewayDevice.X_TP_SmartDmzCfg.",
              "WEB_CFG" : "InternetGatewayDevice.X_TP_WebCfg.",
              "VLAN" : "InternetGatewayDevice.X_TP_VLAN.",
              "ISP_SERVICE" : "InternetGatewayDevice.X_TP_VLAN.IspService.{i}.",
              "WOL" : "InternetGatewayDevice.X_TP_WOL.",
              "WOL_ITEM" : "InternetGatewayDevice.X_TP_WOL.WOL_ITEM.{i}.",
              "IPV6_CFG" : "InternetGatewayDevice.X_TP_IPv6Cfg.",
              "SYS_STATE" : "InternetGatewayDevice.X_TP_SysState.",
              "IPV6_PASS_THROUGH" : "InternetGatewayDevice.X_TP_IPv6PassThrough.",
              "AUTO_REBOOT_CFG" : "InternetGatewayDevice.X_TP_AutoRebootCfg.",
              "CPU_MEM" : "InternetGatewayDevice.X_TP_CpuMemInfo.",
              "PRODUCE_INFO" : "InternetGatewayDevice.X_TP_ProduceInfo."  
    /* 210 */ //"LOCAL" : "InternetGatewayDevice.X_TP_Local.",
    /* 211 */ //"WAN_DETECT" : "InternetGatewayDevice.X_TP_WANDETECT.",
    /* 212 */ //"WAN_DSL_AUTO_PVC_PAIR" : "InternetGatewayDevice.X_TP_WANDETECT.PVCPair.{i}."
    };